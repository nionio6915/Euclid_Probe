...
#define ASSISTED_TRAMMING
  ...
  #define TRAMMING_POINT_XY { { 32.5, 32.5 }, { 184, 117.5 }, { 32.5, 205.2} }
  ...
  */
  #define TRAMMING_POINT_NAME_1 "Front-Left"
  #define TRAMMING_POINT_NAME_2 "Mid-Right"
...
//  #define RESTORE_LEVELING_AFTER_G35    // Enable to restore leveling setup after operation
  ...
  #define ASSISTED_TRAMMING_WAIT_POSITION { X_CENTER, Y_CENTER, 16} // Move the nozzle out of the way for adjustment
...
//#define BEEP_ON_FEEDRATE_CHANGE
  ...
  // Add Probe Z Offset calibration to the Z Probe Offsets menu
    ...
    #define PROBE_OFFSET_WIZARD
      ...
      //
      #define PROBE_OFFSET_WIZARD_START_Z -18.0

      // Set a convenient position to do the calibration (probing point and nozzle/bed-distance)
      #define PROBE_OFFSET_WIZARD_XY_POS {70, 30} // { X_CENTER, Y_CENTER }
    #endif
  #endif
...
#define BABYSTEPPING
  ...
  #define BABYSTEP_DISPLAY_TOTAL          // Display total babysteps since last G28 DJP ENABLE

  #define BABYSTEP_ZPROBE_OFFSET          // Combine M851 Z and Babystepping  DJP ENABLE
 ...
 */
#define GCODE_MACROS // DJP Enable
...
#define CUSTOM_MENU_MAIN // DJP Enable
