...
#define STRING_CONFIG_H_AUTHOR "(djp, Ender3Euclid)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "E3Pro EP V6.2" //DJP EDIT
 ...
 *                                      X, Y, Z [, I [, J [, K]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 200, 200, 100, 100 }
 ...
 */
#define S_CURVE_ACCELERATION  //DJP EDIT ENABLE
 ...
 */
// #define Z_MIN_PROBE_USES_Z_MIN_ENDSTOP_PIN // DJP EDIT DISABLE 
...
// Copy section from a Delta config for the syntax as a starting point.
/**
...
#define Z_PROBE_ALLEN_KEY
  ...
  // DATA SET BELOW IS STARTING POINT FOR ENDER5 WITH EUCLID PROBE DEFINED MOUNT AND DOCKS
  // XY_PROBE_FEEDRATE SETTINGS ARE DEFINED AT LINES ~1225 BELOW

  #define Z_PROBE_ALLEN_KEY_DEPLOY_1 { 100, 0, 10 }  // MOVE TO DOCK ADJACENT, LEFT SIDE DOCK
  #define Z_PROBE_ALLEN_KEY_DEPLOY_1_FEEDRATE (XY_PROBE_FEEDRATE)*1

  #define Z_PROBE_ALLEN_KEY_DEPLOY_2 { 10, 0, 10 }  //  MOVE NEXT TO DOCK SIDE 
  #define Z_PROBE_ALLEN_KEY_DEPLOY_2_FEEDRATE (XY_PROBE_FEEDRATE)*1

  #define Z_PROBE_ALLEN_KEY_DEPLOY_3 { 0, 0, 10.0 }  //  SLOWLY MOVE TO COUPLE PROBE 
  #define Z_PROBE_ALLEN_KEY_DEPLOY_3_FEEDRATE (XY_PROBE_FEEDRATE)/4

  #define Z_PROBE_ALLEN_KEY_DEPLOY_4 { 0, 80, 10.0 }  // MOVE PROBE OUT OF DOCK
  #define Z_PROBE_ALLEN_KEY_DEPLOY_4_FEEDRATE (XY_PROBE_FEEDRATE)/2

  #define Z_PROBE_ALLEN_KEY_STOW_1 { 0, 80, 10.0 } // MOVE TO FRONT OF DOCK
  #define Z_PROBE_ALLEN_KEY_STOW_1_FEEDRATE (XY_PROBE_FEEDRATE)*1

  #define Z_PROBE_ALLEN_KEY_STOW_2 { 0, 0.0, 10.0 } // MOVE PROBE INTO DOCK
  #define Z_PROBE_ALLEN_KEY_STOW_2_FEEDRATE (XY_PROBE_FEEDRATE)/2

  #define Z_PROBE_ALLEN_KEY_STOW_3 { 100.0, 0.0, 0.0 } // SWIPE PROBE OFF DOCK
  #define Z_PROBE_ALLEN_KEY_STOW_3_FEEDRATE (XY_PROBE_FEEDRATE)*1
 ...
 *     |    [-]    |
 *     O-- FRONT --+
 * from acad- Delta X = -45.0768,  Delta Y = 17.7913,   Delta Z = 11.6542 RIGHT SIDE BED MOUNT
...
#define NOZZLE_TO_PROBE_OFFSET { -45.2, -17.5, -10.65 } // LEFT SIDE BED MOUNT


// Most probes should stay away from the edges of the bed, but
// with NOZZLE_AS_PROBE this can be negative for a wider probing area.
// Probing Margin : screw at 32.5 from edge DJP ADD 
...
#define LEVEL_BED_CORNERS // DJP EDIT ENABLE
...
//    #define LEVEL_CORNERS_LEVELING_ORDER { LF, RF, RB, LB } DJP EDIT FOR 3 POINT BRIDGE
#endif
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MAX_POS-1), (Y_MIN_POS/2), 20 }
 ...
 * SD CARD: ENABLE CRC
 *
 * Use CRC checks and retries on the communication.
 */
...
//
#define INDIVIDUAL_AXIS_HOMING_MENU //DJP EDIT ENABLE
