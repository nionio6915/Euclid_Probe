...
; Dock entry/exit point is at X65 Y0 
...
G1 X150 Y30 F3000             ; move to ready position 
G1 X65 Y0  F3000              ; move to the entry position for the dock
G1 X0 Y0  F300                ; move into the dock position
G4 P250                       ; pause 250 usecs 
G1 X0 Y30  F6000              ; move to the side adjacent to the dock swiping the probe off
M400
